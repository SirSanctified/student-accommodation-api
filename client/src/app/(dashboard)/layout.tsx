    ...
    <html lang="en">
      <body className={`${lato.className}`}>
        <div className="mx-auto min-h-screen max-w-7xl">
          ...
          <footer className="border-indigo-blue-500 mx-auto w-full max-w-7xl rounded-t-md border-t bg-gradient-to-t from-indigo-950 to-blue-950 py-4 xl:left-[calc(50%-40rem)]">
